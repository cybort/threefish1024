/*
	...
	v0.1: with a 128 bits tweak operating mode
			   ...
			   u64 *output, u64 t0)
{
	...
	output[15] = cpu_to_le64(b15);
	output[14] = cpu_to_le64(b14);
	output[13] = cpu_to_le64(b13);
	output[12] = cpu_to_le64(b12);
	output[11] = cpu_to_le64(b11);
	output[10] = cpu_to_le64(b10);
	output[9] = cpu_to_le64(b9);
	output[8] = cpu_to_le64(b8);
